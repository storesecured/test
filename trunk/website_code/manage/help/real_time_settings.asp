...
objHelpDict.Add "companyid","The PaySystems companyid assigned to you."
...
objHelpDict.Add "gateway_id","The unique id given to you by itransact to identify your transactions."
objHelpDict.Add "ikobo_account","Your unique iKobo account number for processing transactions."
objHelpDict.Add "ikobo_password","Your unique iKobo password for processing transactions."
objHelpDict.Add "ioc_merchant_id","Bank of America Store Id"
objHelpDict.Add "m_ewaycustomerid","Unique eWay customer id to credit transactions to."
...
objHelpDict.Add "merchant_name","PayReady merchant name.  Used to process transactions."
...
objHelpDict.Add "sec_currency","3 digit currency code to process transactions in."
objHelpDict.Add "sec_merchant","Unique SecPay id for transactions to be credited to."
...
objHelpDict.Add "swissnet_currency","Your swissnet currency code"
objHelpDict.Add "swissnet_language","Your swissnet language"
objHelpDict.Add "swissnet_userid","Your swissnet user id"
objHelpDict.Add "transecute_currency","The currency code for which you would like to process transactions."
objHelpDict.Add "transecute_id","The merchant id given to you by transecute"
objHelpDict.Add "transecute_key","The key code given to you by transecute"
...
objHelpDict.Add "use boa","Store will use Bank of America eStores to process transctions"
...
objHelpDict.Add "use eway","Store will use eWay to process credit cards."
objHelpDict.Add "use gcheckout","Store will use GoogleCheck as an optional. Please fill the following key and id."
objHelpDict.Add "use ikobo","Store will use iKobo to process transactions.  See link for more information or to signup."
objHelpDict.Add "use internet secure","Store uses internet secure to process credit cards."
objHelpDict.Add "use itransact","Store uses itransact to process credit cards."
...
objHelpDict.Add "use payready","Store will use PayReady to process transactions."
objHelpDict.Add "use paysystems","Store will use Paysystems to process transactions.  See link for more information or to signup."
...
objHelpDict.Add "use secpay","Store will use SecPay to process credit cards."
objHelpDict.Add "use swissnet","Use SwissNet payment gateway to process transactions"
objHelpDict.Add "use transecutex","Use transecute payment gateway to process transactions"
objHelpDict.Add "use viaklix","Store will use viaKlix for credit card processing."
...
objHelpDict.Add "viaklix_merchant_id","The unique id given to you by viaKlix"
objHelpDict.Add "viaklix_pin","The unique pin give to you by viaKlix"
