...
myStructure("TableName") = "store_banners_impressions"
myStructure("TableWhere") = "Banner_ID="&request.querystring("Id")&" and BDate<='"&End_Date1&"' and BDate>='"&Start_Date&"'"
myStructure("ColumnList") = "banner_impression_id,bdate,client_ip"
myStructure("DefaultSort") = "bdate"
myStructure("PrimaryKey") = "banner_impression_id"
myStructure("Level") = 5
...
myStructure("FileName") = "banners_ri.asp?Id="&request.querystring("Id")
myStructure("FormAction") = "banners_ri.asp?Id="&request.querystring("Id")
myStructure("Title") = "Banner #"&request.querystring("Id")&" Impressions"
myStructure("FullTitle") = "Marketing > <a href=banners.asp class=white>Banners</a> > #"&request.querystring("Id")&" > Impressions"
myStructure("CommonName") = "Banner Impression"
myStructure("NewRecord") = ""
myStructure("Heading:banner_impression_id") = "PK"
...
<tr><td colspan=10><table width='100%' border='0' cellspacing='1' cellpadding=2><tr bgcolor='#FFFFFF'>
	...
	<tr bgcolor='#FFFFFF'><td colspan=3 align=center><input class=buttons type="submit" value="Search"></td></tr>
</table></TD></TR>
