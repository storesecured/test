...
if trim(request.querystring("action"))="login"  then
	...
	'query for retrieving database values
		...
		if not rscheck.eof and not rscheck.bof then
			...
			Response.Redirect "reseller_home.asp"
			Response.End
        ...
        <TR>
          <TD class=pagetitle height=400 vAlign=top>Login 
            <TABLE align=left border=0 cellPadding=0 cellSpacing=0 
              width="90%"><FORM action="javascript:fnlogin()"  method=post name="frmlogin"><INPUT name=Form_Name type=hidden> 
              ...
              <TR>
                ...
                <TD class=inputvalue><INPUT name=Store_User_Id maxlength=20>
</TD>
                </TR>
              <TR>
                <TD class=inputname><B>Password</B></td> 
                <TD class=inputvalue><INPUT name=Store_Password type=password maxlength=20>
                </TD>
