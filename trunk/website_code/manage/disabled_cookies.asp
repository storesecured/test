...
if sCookies=0 then %>
     <p><ul><b>Your browser does not support cookies, this application requires the use of cookies.  Please choose a browser that does support cookies in order to continue.</b></ul>
<% elseif sCookies=-1 then %>

<table><TR><TD colspan=2><BR><BR>

		 <table><tr><td bgcolor=red align=center><B><font color=white>Your browser has disabled session cookies.  This site uses temporary, session-based cookies that are created when you log in and automatically erased when you close your browser.</font></b></td></tr></table>
