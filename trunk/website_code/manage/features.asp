...
<LI>Added PayStation payment gateway integration
</UL></td></tr>
...
<LI><a href=orders.asp class=link>Auto capture, void and credit</a> for echo, authorize.net, linkpoint and plugnpay
<LI>Updated <a href=help.asp class=link>online help</a> files
...
<LI>Added <a href=real_time_settings.asp class=link>Transecute Gateway Integration</a>
...
<LI>Added online <a href=support.asp class=link>support request</a> form
...
<LI>Added <a href=real_time_settings.asp class=link>SecPay, NoChex, MoneyBookers, and eWay realtime gateway</a> credit card integration
...
<LI>Added PayReady integration</UL></td></tr>
...
<LI>Added auto return authorization (SILVER+)</UL></td></tr>
  ...
  <LI>Modified ship to multiple locations to allow shopper to ship the same item purchased more than once to separate locations. (SILVER+)</UL></td></tr>
	  ...
	  <LI>Allow auto capture of funds on shipment for Echo and Authorize.net</UL></td></tr>
...
<tr bgcolor='#FFFFFF'><td><B>6/24/2003</B><BR><UL><LI>Added feature to allow shopper to easily return to the page they were currently
	...
	<LI>Added integration of new payment gateways,2Checkout, iTransact, InternetSecure and PlugnPay</UL></td></tr>
