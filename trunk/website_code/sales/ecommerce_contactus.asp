...
if request.form("Update") <> "" then
    ...
    if instr(fromemail,"@") > 0 and instr(fromemail," ") = 0 then
       ...
       Mail.Subject = "easystorecreator contact form from " & fromname
       Mail.Body = message
       Mail.Queue = True
       Mail.Send
...
<br>
Current customers please <a class=link href=http://manage.easystorecreator.com>login</a>
 to the admin interface to submit a support request.
<BR><BR>
<table border=1 cellspacing=0 cellpadding=5>
<tr><td><b>Email</b></td><td>sales&#64;easystorecreator.com</td><td>Anytime</td></tr>
...
<BR><BR>
If you have forgotten your password please <a href=http://manage.easystorecreator.com/forgot_password.asp>click here</a>
<BR><BR>
If you would like to exchange links please <a href=http://www.easystorecreator.com/links/add_link.html>click here</a>
