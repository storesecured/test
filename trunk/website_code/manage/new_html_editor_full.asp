...
<title>HTML Editor</title>
    ...
    Form1.submit()
		...
		window.parent.opener.setResults(resArg, oEdit<%= sTextFieldName %>.getHTML());
		window.parent.close();
...
<script>
			...
			oEdit<%= sTextFieldName %>.height="92%";
               oEdit<%= sTextFieldName %>.mode="HTML";
			...
			oEdit<%= sTextFieldName %>.cmdAssetManager = "modalDialogShow('/Editor/assetmanager/assetmanager.asp',640,465)"; //Command to open the Asset Manager add-on.
  			oEdit<%= sTextFieldName %>.cmdInternalLink = "window.open('editor_internal.asp','mywindow','resizable=0,width=350,height=380')"; //Command to open your custom link lookup page.
