...
if Session("Location_List:"&Store_Id) = "" then
   ...
   set myfields=server.createobject("scripting.dictionary")
	...
	Session("Location_List:"&Store_Id)=sList
end if

function create_location_list (sFieldName,sValue,sSize)
	if Session("Location_List:"&Store_Id)="Empty" then
      ...
      sText =sText&"<Option value='0' "&sSelected&">Default"
		...
		for each sLocationRecord in split(Session("Location_List:"&Store_Id),"|{new}|")
