...
Function ShowUserTheErrorDetails()
   shost = "http://"&request.servervariables("HTTP_HOST")
	...
	if strErrorNo = 0 then
	   ...
	   blnSendAdminMail=false
           'response.redirect shost&"/store.asp"
        elseif strErrorNo="-2147467259" and strErrorCode="ASP 0127" then
           blnSendAdminMail=false
           'response.redirect shost&"/error.asp?Message_Id=101&Message_Add="&server.urlencode("An error has occurred.  There is a start of comment tag in this page ("&strFileName&") but no end of comment, this page cannot be viewed at this time.<BR><HR><BR>Store Owner please either remove the start of comment for this page or make sure that you properly end your comment to correct this error.")
	elseif (strErrorNo = "-2147467259" and strErrorCode="ASP 0113") or strErrorNo = "-2147217871" then
	   blnSendAdminMail=false
	   'timeout asp error or timeout sql error
           'response.redirect shost&"/error.asp?Message_Id=101&Message_Add="&server.urlencode("An error has occurred.  The server timed out processing your request.  Please try working with a smaller set of data or wait a few moments and simply try again.")
        elseif strErrorNo = "-2147217900" or strErrorNo = "-2147217887" or strErrNo="-2146828275" or strErrNo="-2146828194" or (strErrorNo = "-2147467259" and strErrorCode="ASP 0126") or strErrorNo="-2146828212" then
           'incorrect sql syntax and multiple step ole db and type mismatch and invalid use of null or include file not found or path not found
	   elseif strErrorNo = "-2147012889" then
           'unable to resolve hostname
	   blnSendAdminMail=false
           'response.redirect shost&"/error.asp?Message_Id=101&Message_Add="&server.urlencode("An error has occurred.  The server is unable to connect to the 3rd party application.  Please wait a few moments and try again or contact the store admin.")
