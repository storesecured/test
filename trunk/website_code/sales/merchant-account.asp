...
<!--#include file="header.asp"-->
		...
		<p class="bodytext"><b>What is a merchant account?</b><BR>
		  ...
		  authorization and charges in real-time. The merchant accounts <%=Name %> 
		  ...
		  by a merchant account processor. <%=Name %>'s partnerships with many
		  ...
		  <B>Credit Card Fraud</b><BR>
		  Internet credit card fraud has always been a problem. All of our merchant account provider companies do their best
		  to catch fraud.  <%=Name %> now comes enabled with 
        ...
        guaranteed against fraud and chargebacks.<BR>
		  ...
		  <%=Name %> has choosen to partner with some of the largest and most 
		  ...
		  please feel free to <a href="ecommerce_contactus.asp">contact us</a>.  We are here 
		  to help. 
		...
		<p>To learn more about the <a href="integrated-gateways.asp">merchant accounts supported</a> by <%=Name %>
		  click here</p>
