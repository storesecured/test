...
on error resume next
        ...
        objShip = New dotnetSHIP.Ship()
            ...
            objShip.DestStateProvince = Request.Params("DestST")

            If Request.Params("USE_UPS") And 1 = 0 Then
            ...
            End If
            If Request.Params("USE_FEDEX") Then
                ...
                if Request.Params("Fedex_Account_Number")<>"" and Request.Params("Fedex_Meter_Number")<>"" then
                   objShip.FedExLogin = Request.Params("Fedex_Account_Number")&","&Request.Params("Fedex_Meter_Number")
                else
                    objShip.FedExLogin = "239367186,1828724"  ' "Account number, meter number"
                end if
            ...
            Else
                ...
                objShip2.DestStateProvince = Request.Params("DestST")
                ...
                If (objShip2.Error) <> "" and (objShip.Error)="" And Request.Params("OrgCty") <> "ZW" Then
