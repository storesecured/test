		...
		Case "Shipping_Class"
			...
			if request.form("USE_AIRBORNE")<>"" then
				...
				USE_AIRBORNE=0
				   ...
				   If Use_UPS and Use_Fedex then
                   fn_error "Fedex cannot be enabled at the same time as UPS.  Please choose to enable one or the other.  UPS does not allow their rates to be presented in conjunction with Fedex rates."
               end if
               if request.form("USE_UPS")<>"" then
