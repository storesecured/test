...
tracking_page_name="privacy"

%>
<!--#include file="header.asp"-->
<b>Privacy Policy Statement</b>
<BR><BR>
This is the web site of <%=Name %> a division of StoreSecured, Inc.
<BR><BR>
Our postal address is<BR>
10272 Aviary Drive<BR>
San Diego, CA 92131<BR>
<BR><BR>
We can be reached via e-mail at <%=sSupport_email %><BR>
<BR><BR>
...
<BR><BR>
<a href=ecommerce_contactus.asp>I have a question for you.</a>
