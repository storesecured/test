...
<TR><TD><a href="http://www.easystorecreator.com?Id=<%= Affiliate_ID %>">Put your business on the web today at Easystorecreator.com</a><BR>
<textarea rows=4 cols=55><a href="http://www.easystorecreator.com?Id=<%= Affiliate_ID %>">Put your business on the web today at Easystorecreator.com</a></textarea><BR>
</td></tr>
<tr><td>
<a href="http://www.easystorecreator.com?Id=<%= Affiliate_ID %>">Website builder, domain name and hosting all for one low monthly fee, at Easystorecreator.com</a><BR>
<textarea rows=4 cols=55><a href="http://www.easystorecreator.com?Id=<%= Affiliate_ID %>">Website builder, domain name and hosting all for one low monthly fee at Easystorecreator.com</a></textarea>
</td></tr></table>
