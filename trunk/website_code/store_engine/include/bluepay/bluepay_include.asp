...
Dim  BP_RESPONSE
Dim  BP_ACH_ROUTING,BP_ACH_ACCOUNT,BP_PAYMENT_TYPE
...
Sub bp_set_cust_required_ach(in_routing, in_account, in_none, _
                     in_name, in_addr1, in_city, in_state, in_zip)

  BP_ACH_ROUTING     = in_routing
  BP_ACH_ACCOUNT    = in_account
  BP_PAYMENT_TYPE   = "ACH"    
  BP_NAME       = in_name
  BP_ADDR1      = in_addr1
  BP_CITY       = in_city
...
Sub bp_process()
  ...
  if BP_PAYMENT_TYPE = "ACH" then
        serverquery=serverquery & _
                "&ACH_ROUTING="            & Server.URLEncode(BP_ACH_ROUTING) & _
		"&ACH_ACCOUNT="            & Server.URLEncode(BP_ACH_ACCOUNT) & _
		"&PAYMENT_TYPE="        & Server.URLEncode(BP_PAYMENT_TYPE)
  ...
  Session("serverquery")=serverquery
