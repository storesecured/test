...
<!--#include file="header.asp"-->
		  <h1>All Easystorecreator packages include free WYSIWIG web page builders, sometimes called HTML Editors to help our customers build their web pages.</h1>
		<p><B>WYSIWYG</b> tools are graphical web pages builders that allow even web novices to build web pages.
		Easystorecreator offers free html editors to build your stores web pages.	These WYSIWYG Editors will
		help you to format text, add colors, add images, insert hyperlinks and more.</p>
		<p>In addition to WYSIWYG page editing tools, Easystorecreator offers full shopping cart integration.  Add as many
		html web pages to your site as needed and format them using our easy to use html editor.</p>

		<p>
		Easystorecreator understands that not everyone knows html and you shouldn't have to.
		...
		<P>Easystorecreator offers both services both of which include html editing tools such as the
